...
public class DatabaseSetup {
    ...
    private static final String URL_TESTDB = "jdbc:postgresql://localhost:5432/timetableassistant";
    ...
    private static void createTables() {
        try (Connection conn = DriverManager.getConnection(URL_TESTDB, USER, PASSWORD);
             Statement stmt = conn.createStatement()) {
